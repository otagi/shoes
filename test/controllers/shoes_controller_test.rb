...
class ShoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post shoes_url, params: { shoe: { brand: @shoe.brand, colorway: @shoe.colorway, name: @shoe.name, price: @shoe.price } }
    end
  ...
  test "should update shoe" do
    patch shoe_url(@shoe), params: { shoe: { brand: @shoe.brand, colorway: @shoe.colorway, name: @shoe.name, price: @shoe.price } }
